...
output_figures_dir = joinpath(dropbox_output_dir, "P_O_A_U_x2CPsea")
...
ooeoae_expts(
    model, [
        ...
        ("CPsea", 115.4, 115.4*2), # base setup values for Bergman_COPSE
...
expts_table = [
    # anoxic threshold Corgb = 0.74 (stable), Corgb=0.75(oscillation)
    # oxic threshold Corgb = 1.15 (oscillation), Corgb=1.2(stable)
    ("POASU 1", "EG_regime_stableanoxic_to_unstable1_lowCPsea", 
        [
            ("k_O2_U", (0.23, 0.25)), 
            ("corg_burial_fac", 1.0), 
            ("OPAinit", (0.3*3.7e19, 2*3.1e15, 4.2*3.193e18)),

            ("set_interp_forcing", "ocean", "force_corg_bf", [-1e30, 5e6 - 1, 5e6, 26e6, 26e6+1, 35e6, 1e30], [0.65, 0.65, 0.785, 0.785, 1.1, 1.1, 1.1],),
        ]),
